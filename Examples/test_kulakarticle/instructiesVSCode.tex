...
\begin{enumerate}
	\item De repository \texttt{KULeuvenLaTeXClasses} bevat een map met Kulak-templates. Noteer de locatie van deze map op je lokale systeem, bijvoorbeeld
...
\section{Gebruik van de VS Code-extensie LaTeX Workshop}
\label{sec:vscode}
