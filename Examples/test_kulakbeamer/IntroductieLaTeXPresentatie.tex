\documentclass[kulak,handout,sedes]{kulakbeamer} % handout
...
\end{verbatim}
		...
		\begin{stelling} {Naam van stelling}
			\begin{verbatim}
\begin{theorem} {Naam van stelling}
\end{theorem}
\end{verbatim}
		\end{stelling}
		%\begin{itemize}
...
\structure <4> {Benadrukken}

\alert <5> {Benadrukken}

\textit <6> {Tekstopmaak toepassen}
\end{verbatim}
		\end{exampleblock}
		\column{.5\textwidth}
		\begin{itemize}
			\item \verb+<2->+: slide specificatie
			\item \verb+\uncover+: \uncover<2->{Zichtbaar maken}
			\item<only@3-4> \verb+\only+: Tekst tussenvoegen
			\item \verb+\structure+ en \verb+\alert+:\newline  \structure<4>{\alert<5>{Tekst benadrukken}}
			\item \verb+\textit+:\newline  \textit<6>{Tekstopmaak toepassen}
		\end{itemize}
	\end{columns}
\end{frame}
...
\item<structure@2|2,4-> Combinatie
\end{verbatim}
		\end{exampleblock}
		\column{.5\textwidth}
		...
		\begin{itemize}
			...
			\item<2-> Vanaf slide 2
			\item<-2,4|alert@4> Tot slide twee gewoon, op slide 4 benadrukt
			\item<structure@2|2,4-> Op slide 2 benadrukt, vanaf slide 4 gewoon
		\end{itemize}
	\end{columns}
\end{frame}
...
\end{verbatim}
		...
		\begin{itemize}
			...
			\item \verb|\hyperlink{label1}{tekst}|
			      ...
			      \end{itemize}
			\item<2> \verb+\beamergotobutton{}+: \hyperlink{vorige}{\beamergotobutton{Vorige slide}}
		\end{itemize}
		
	\end{columns}
	\hypertarget<1>{vorige}{}
\end{frame}
...
\begin{frame}[fragile,t]
	...
	Huisstijl kleurenpallet 
	\begin{itemize}
		\item Corporate kleuren:\newline \textcolor{KULzwart}{KULwit}, \textcolor{KULijsblauw}{KULijsblauw}, \textcolor{KULcorporate}{KULcorporate}, \textcolor{KULpetrol}{KULpetrol}
		\item Accentkleuren:\newline
		      \textcolor{KULzwart}{KULzwart},
		      \textcolor{KULrood}{KULrood},
		      \textcolor{KULoranje}{KULoranje},
		      \textcolor{KULgeel}{KULgeel},
		      \textcolor{KULgroen}{KULgroen},
		      \textcolor{KULblauw}{KULblauw},
		      \textcolor{KULpaars}{KULpaars}
	\end{itemize}
\end{frame}
